...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000ec2:	7be080e7          	jalr	1982(ra) # 8000267c <trapinithart>
  ...
  scheduler();        
    ...
    80000f3a:	71e080e7          	jalr	1822(ra) # 80002654 <trapinit>
    trapinithart();  // install kernel trap vector
    80000f3e:	00001097          	auipc	ra,0x1
    80000f42:	73e080e7          	jalr	1854(ra) # 8000267c <trapinithart>
...
forkret(void)
{
  ...
  usertrapret();
    ...
    80001a0a:	c8e080e7          	jalr	-882(ra) # 80002694 <usertrapret>
}
...
0000000080001ea2 <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001f38:	6b6080e7          	jalr	1718(ra) # 800025ea <swtch>
        c->proc = 0;
...
0000000080001f42 <sched>:
{
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001fba:	634080e7          	jalr	1588(ra) # 800025ea <swtch>
...
0000000080002188 <exit>:
{
  ...
  if(p == initproc)
    ...
    800021d0:	36c080e7          	jalr	876(ra) # 80004538 <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    800021e8:	e88080e7          	jalr	-376(ra) # 8000406c <begin_op>
  iput(p->cwd);
    800021ec:	1709b503          	ld	a0,368(s3)
    800021f0:	00001097          	auipc	ra,0x1
    800021f4:	674080e7          	jalr	1652(ra) # 80003864 <iput>
  end_op();
    800021f8:	00002097          	auipc	ra,0x2
    800021fc:	ef4080e7          	jalr	-268(ra) # 800040ec <end_op>
  p->cwd = 0;
  ...
  strncpy(p->exit_msg, msg, 32);
    80002236:	02000613          	li	a2,32
    8000223a:	85d6                	mv	a1,s5
    8000223c:	03498513          	addi	a0,s3,52
    80002240:	fffff097          	auipc	ra,0xfffff
    80002244:	b9e080e7          	jalr	-1122(ra) # 80000dde <strncpy>
  p->xstate = status;
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002290:	f0498993          	addi	s3,s3,-252 # 80017190 <tickslock>
    acquire(&p->lock);
...
0000000080002344 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80002370:	80c50513          	addi	a0,a0,-2036 # 80010b78 <wait_lock>
    ...
    80002386:	e0e98993          	addi	s3,s3,-498 # 80017190 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000238a:	0000ec97          	auipc	s9,0xe
    8000238e:	7eec8c93          	addi	s9,s9,2030 # 80010b78 <wait_lock>
    havekids = 0;
    80002392:	8762                	mv	a4,s8
    for(pp = proc; pp < &proc[NPROC]; pp++){
    80002394:	0000f497          	auipc	s1,0xf
    80002398:	bfc48493          	addi	s1,s1,-1028 # 80010f90 <proc>
    8000239c:	a059                	j	80002422 <wait+0xde>
          pid = pp->pid;
    8000239e:	0304a983          	lw	s3,48(s1)
          if(addr != 0 && copyout(p->pagetable, addr, (char *)&pp->xstate,
    800023a2:	000b0e63          	beqz	s6,800023be <wait+0x7a>
    800023a6:	4691                	li	a3,4
    800023a8:	02c48613          	addi	a2,s1,44
    800023ac:	85da                	mv	a1,s6
    800023ae:	07093503          	ld	a0,112(s2)
    800023b2:	fffff097          	auipc	ra,0xfffff
    800023b6:	2b6080e7          	jalr	694(ra) # 80001668 <copyout>
    800023ba:	04054163          	bltz	a0,800023fc <wait+0xb8>
          copyout(p->pagetable, *msg , p->exit_msg, 32);
    800023be:	02000693          	li	a3,32
    800023c2:	03490613          	addi	a2,s2,52
    800023c6:	000bc583          	lbu	a1,0(s7) # fffffffffffff000 <end+0xffffffff7ffdca90>
    800023ca:	07093503          	ld	a0,112(s2)
    800023ce:	fffff097          	auipc	ra,0xfffff
    800023d2:	29a080e7          	jalr	666(ra) # 80001668 <copyout>
          freeproc(pp);
    800023d6:	8526                	mv	a0,s1
    800023d8:	fffff097          	auipc	ra,0xfffff
    800023dc:	786080e7          	jalr	1926(ra) # 80001b5e <freeproc>
          release(&pp->lock);
    ...
    800023f6:	898080e7          	jalr	-1896(ra) # 80000c8a <release>
          return pid;
    800023fa:	a0b5                	j	80002466 <wait+0x122>
            release(&pp->lock);
    800023fc:	8526                	mv	a0,s1
    800023fe:	fffff097          	auipc	ra,0xfffff
    80002402:	88c080e7          	jalr	-1908(ra) # 80000c8a <release>
            release(&wait_lock);
    80002406:	0000e517          	auipc	a0,0xe
    8000240a:	77250513          	addi	a0,a0,1906 # 80010b78 <wait_lock>
    8000240e:	fffff097          	auipc	ra,0xfffff
    80002412:	87c080e7          	jalr	-1924(ra) # 80000c8a <release>
            return -1;
    80002416:	59fd                	li	s3,-1
    80002418:	a0b9                	j	80002466 <wait+0x122>
    for(pp = proc; pp < &proc[NPROC]; pp++){
    8000241a:	18848493          	addi	s1,s1,392
    8000241e:	03348463          	beq	s1,s3,80002446 <wait+0x102>
      if(pp->parent == p){
    80002422:	6cbc                	ld	a5,88(s1)
    80002424:	ff279be3          	bne	a5,s2,8000241a <wait+0xd6>
        acquire(&pp->lock);
    ...
    80002434:	f74785e3          	beq	a5,s4,8000239e <wait+0x5a>
        release(&pp->lock);
    80002438:	8526                	mv	a0,s1
    8000243a:	fffff097          	auipc	ra,0xfffff
    8000243e:	850080e7          	jalr	-1968(ra) # 80000c8a <release>
        havekids = 1;
    80002442:	8756                	mv	a4,s5
    80002444:	bfd9                	j	8000241a <wait+0xd6>
    if(!havekids || killed(p)){
    80002446:	c719                	beqz	a4,80002454 <wait+0x110>
    80002448:	854a                	mv	a0,s2
    8000244a:	00000097          	auipc	ra,0x0
    8000244e:	ec8080e7          	jalr	-312(ra) # 80002312 <killed>
    80002452:	c905                	beqz	a0,80002482 <wait+0x13e>
      release(&wait_lock);
    80002454:	0000e517          	auipc	a0,0xe
    80002458:	72450513          	addi	a0,a0,1828 # 80010b78 <wait_lock>
    ...
    80002468:	60e6                	ld	ra,88(sp)
    8000246a:	6446                	ld	s0,80(sp)
    8000246c:	64a6                	ld	s1,72(sp)
    8000246e:	6906                	ld	s2,64(sp)
    80002470:	79e2                	ld	s3,56(sp)
    80002472:	7a42                	ld	s4,48(sp)
    80002474:	7aa2                	ld	s5,40(sp)
    80002476:	7b02                	ld	s6,32(sp)
    80002478:	6be2                	ld	s7,24(sp)
    8000247a:	6c42                	ld	s8,16(sp)
    8000247c:	6ca2                	ld	s9,8(sp)
    8000247e:	6125                	addi	sp,sp,96
    80002480:	8082                	ret
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002482:	85e6                	mv	a1,s9
    80002484:	854a                	mv	a0,s2
    80002486:	00000097          	auipc	ra,0x0
    8000248a:	bce080e7          	jalr	-1074(ra) # 80002054 <sleep>
    havekids = 0;
    8000248e:	b711                	j	80002392 <wait+0x4e>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002566:	ba648493          	addi	s1,s1,-1114 # 80011108 <proc+0x178>
    8000256a:	00015917          	auipc	s2,0x15
    8000256e:	d9e90913          	addi	s2,s2,-610 # 80017308 <bcache+0x160>
    if(p->state == UNUSED)
      continue;
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    800025ae:	18848493          	addi	s1,s1,392
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80002660:	c9c58593          	addi	a1,a1,-868 # 800082f8 <states.0+0x30>
    80002664:	00015517          	auipc	a0,0x15
    80002668:	b2c50513          	addi	a0,a0,-1236 # 80017190 <tickslock>
    8000266c:	ffffe097          	auipc	ra,0xffffe
    80002670:	4da080e7          	jalr	1242(ra) # 80000b46 <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80002686:	4fe78793          	addi	a5,a5,1278 # 80005b80 <kernelvec>
...
usertrapret(void)
{
  ...
  struct proc *p = myproc();
    ...
    800026a0:	310080e7          	jalr	784(ra) # 800019ac <myproc>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  uint64 satp = MAKE_SATP(p->pagetable);
    8000270a:	7928                	ld	a0,112(a0)
    8000270c:	8131                	srli	a0,a0,0xc
  ...
  uint64 trampoline_userret = TRAMPOLINE + (userret - trampoline);
    ...
    80002712:	98e70713          	addi	a4,a4,-1650 # 8000709c <userret>
    80002716:	8f11                	sub	a4,a4,a2
    80002718:	97ba                	add	a5,a5,a4
  ((void (*)(uint64))trampoline_userret)(satp);
    8000271a:	577d                	li	a4,-1
    8000271c:	177e                	slli	a4,a4,0x3f
    8000271e:	8d59                	or	a0,a0,a4
    80002720:	9782                	jalr	a5
}
    80002722:	60a2                	ld	ra,8(sp)
    80002724:	6402                	ld	s0,0(sp)
    80002726:	0141                	addi	sp,sp,16
    80002728:	8082                	ret

000000008000272a <clockintr>:
  w_sstatus(sstatus);
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    80002734:	00015497          	auipc	s1,0x15
    80002738:	a5c48493          	addi	s1,s1,-1444 # 80017190 <tickslock>
  ...
  ticks++;
    ...
    8000274a:	1aa50513          	addi	a0,a0,426 # 800088f0 <ticks>
    8000274e:	411c                	lw	a5,0(a0)
    80002750:	2785                	addiw	a5,a5,1
    80002752:	c11c                	sw	a5,0(a0)
  wakeup(&ticks);
    80002754:	00000097          	auipc	ra,0x0
    80002758:	964080e7          	jalr	-1692(ra) # 800020b8 <wakeup>
  release(&tickslock);
...
devintr()
{
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    8000277a:	14202773          	csrr	a4,scause
  uint64 scause = r_scause();

  if((scause & 0x8000000000000000L) &&
    8000277e:	00074d63          	bltz	a4,80002798 <devintr+0x28>
    ...
    8000278a:	06f70363          	beq	a4,a5,800027f0 <devintr+0x80>
  }
}
    ...
    80002796:	8082                	ret
     (scause & 0xff) == 9){
    80002798:	0ff77793          	andi	a5,a4,255
  if((scause & 0x8000000000000000L) &&
    8000279c:	46a5                	li	a3,9
    8000279e:	fed792e3          	bne	a5,a3,80002782 <devintr+0x12>
    int irq = plic_claim();
    800027a2:	00003097          	auipc	ra,0x3
    800027a6:	4e6080e7          	jalr	1254(ra) # 80005c88 <plic_claim>
    800027aa:	84aa                	mv	s1,a0
    if(irq == UART0_IRQ){
    800027ac:	47a9                	li	a5,10
    800027ae:	02f50763          	beq	a0,a5,800027dc <devintr+0x6c>
    } else if(irq == VIRTIO0_IRQ){
    800027b2:	4785                	li	a5,1
    800027b4:	02f50963          	beq	a0,a5,800027e6 <devintr+0x76>
    return 1;
    800027b8:	4505                	li	a0,1
    } else if(irq){
    800027ba:	d8f1                	beqz	s1,8000278e <devintr+0x1e>
      printf("unexpected interrupt irq=%d\n", irq);
    800027bc:	85a6                	mv	a1,s1
    800027be:	00006517          	auipc	a0,0x6
    800027c2:	b4250513          	addi	a0,a0,-1214 # 80008300 <states.0+0x38>
    800027c6:	ffffe097          	auipc	ra,0xffffe
    800027ca:	dc2080e7          	jalr	-574(ra) # 80000588 <printf>
      plic_complete(irq);
    800027ce:	8526                	mv	a0,s1
    800027d0:	00003097          	auipc	ra,0x3
    800027d4:	4dc080e7          	jalr	1244(ra) # 80005cac <plic_complete>
    return 1;
    800027d8:	4505                	li	a0,1
    800027da:	bf55                	j	8000278e <devintr+0x1e>
      uartintr();
    800027dc:	ffffe097          	auipc	ra,0xffffe
    800027e0:	1be080e7          	jalr	446(ra) # 8000099a <uartintr>
    800027e4:	b7ed                	j	800027ce <devintr+0x5e>
      virtio_disk_intr();
    800027e6:	00004097          	auipc	ra,0x4
    800027ea:	992080e7          	jalr	-1646(ra) # 80006178 <virtio_disk_intr>
    800027ee:	b7c5                	j	800027ce <devintr+0x5e>
    if(cpuid() == 0){
    800027f0:	fffff097          	auipc	ra,0xfffff
    800027f4:	190080e7          	jalr	400(ra) # 80001980 <cpuid>
    800027f8:	c901                	beqz	a0,80002808 <devintr+0x98>
  ...
  asm volatile("csrw sip, %0" : : "r" (x));
    ...
    80002806:	b761                	j	8000278e <devintr+0x1e>
      clockintr();
    80002808:	00000097          	auipc	ra,0x0
    8000280c:	f22080e7          	jalr	-222(ra) # 8000272a <clockintr>
    80002810:	b7ed                	j	800027fa <devintr+0x8a>
...
0000000080002812 <usertrap>:
{
  ...
  if((r_sstatus() & SSTATUS_SPP) != 0)
    ...
    80002826:	e3b1                	bnez	a5,8000286a <usertrap+0x58>
  asm volatile("csrw stvec, %0" : : "r" (x));
    80002828:	00003797          	auipc	a5,0x3
    8000282c:	35878793          	addi	a5,a5,856 # 80005b80 <kernelvec>
  ...
  if(r_scause() == 8){
    ...
    8000284c:	02f70763          	beq	a4,a5,8000287a <usertrap+0x68>
  } else if((which_dev = devintr()) != 0){
    80002850:	00000097          	auipc	ra,0x0
    80002854:	f20080e7          	jalr	-224(ra) # 80002770 <devintr>
    80002858:	892a                	mv	s2,a0
    8000285a:	c541                	beqz	a0,800028e2 <usertrap+0xd0>
  if(killed(p))
    8000285c:	8526                	mv	a0,s1
    8000285e:	00000097          	auipc	ra,0x0
    80002862:	ab4080e7          	jalr	-1356(ra) # 80002312 <killed>
    80002866:	c931                	beqz	a0,800028ba <usertrap+0xa8>
    80002868:	a099                	j	800028ae <usertrap+0x9c>
    panic("usertrap: not from user mode");
    8000286a:	00006517          	auipc	a0,0x6
    8000286e:	ab650513          	addi	a0,a0,-1354 # 80008320 <states.0+0x58>
    80002872:	ffffe097          	auipc	ra,0xffffe
    80002876:	ccc080e7          	jalr	-820(ra) # 8000053e <panic>
    if(killed(p))
    8000287a:	00000097          	auipc	ra,0x0
    8000287e:	a98080e7          	jalr	-1384(ra) # 80002312 <killed>
    80002882:	e929                	bnez	a0,800028d4 <usertrap+0xc2>
    p->trapframe->epc += 4;
    80002884:	7cb8                	ld	a4,120(s1)
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000289c:	2d8080e7          	jalr	728(ra) # 80002b70 <syscall>
  if(killed(p))
    800028a0:	8526                	mv	a0,s1
    800028a2:	00000097          	auipc	ra,0x0
    800028a6:	a70080e7          	jalr	-1424(ra) # 80002312 <killed>
    800028aa:	c919                	beqz	a0,800028c0 <usertrap+0xae>
    800028ac:	4901                	li	s2,0
    exit(-1,0);
    800028ae:	4581                	li	a1,0
    800028b0:	557d                	li	a0,-1
    800028b2:	00000097          	auipc	ra,0x0
    800028b6:	8d6080e7          	jalr	-1834(ra) # 80002188 <exit>
  if(which_dev == 2)
    800028ba:	4789                	li	a5,2
    800028bc:	06f90063          	beq	s2,a5,8000291c <usertrap+0x10a>
  usertrapret();
    800028c0:	00000097          	auipc	ra,0x0
    800028c4:	dd4080e7          	jalr	-556(ra) # 80002694 <usertrapret>
}
    ...
    800028dc:	8b0080e7          	jalr	-1872(ra) # 80002188 <exit>
    800028e0:	b755                	j	80002884 <usertrap+0x72>
  asm volatile("csrr %0, scause" : "=r" (x) );
    800028e2:	142025f3          	csrr	a1,scause
    printf("usertrap(): unexpected scause %p pid=%d\n", r_scause(), p->pid);
    800028e6:	5890                	lw	a2,48(s1)
    800028e8:	00006517          	auipc	a0,0x6
    800028ec:	a5850513          	addi	a0,a0,-1448 # 80008340 <states.0+0x78>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002904:	a7050513          	addi	a0,a0,-1424 # 80008370 <states.0+0xa8>
    ...
    80002916:	9d4080e7          	jalr	-1580(ra) # 800022e6 <setkilled>
    8000291a:	b759                	j	800028a0 <usertrap+0x8e>
    yield();
    8000291c:	fffff097          	auipc	ra,0xfffff
    80002920:	6fc080e7          	jalr	1788(ra) # 80002018 <yield>
    80002924:	bf71                	j	800028c0 <usertrap+0xae>
...
0000000080002926 <kerneltrap>:
{
  ...
  if((which_dev = devintr()) == 0){
    ...
    80002952:	e22080e7          	jalr	-478(ra) # 80002770 <devintr>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002978:	a1c50513          	addi	a0,a0,-1508 # 80008390 <states.0+0xc8>
    8000297c:	ffffe097          	auipc	ra,0xffffe
    80002980:	bc2080e7          	jalr	-1086(ra) # 8000053e <panic>
    panic("kerneltrap: interrupts enabled");
    80002984:	00006517          	auipc	a0,0x6
    80002988:	a3450513          	addi	a0,a0,-1484 # 800083b8 <states.0+0xf0>
    8000298c:	ffffe097          	auipc	ra,0xffffe
    80002990:	bb2080e7          	jalr	-1102(ra) # 8000053e <panic>
    printf("scause %p\n", scause);
    80002994:	85ce                	mv	a1,s3
    80002996:	00006517          	auipc	a0,0x6
    8000299a:	a4250513          	addi	a0,a0,-1470 # 800083d8 <states.0+0x110>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    800029b2:	a3a50513          	addi	a0,a0,-1478 # 800083e8 <states.0+0x120>
    800029b6:	ffffe097          	auipc	ra,0xffffe
    800029ba:	bd2080e7          	jalr	-1070(ra) # 80000588 <printf>
    panic("kerneltrap");
    800029be:	00006517          	auipc	a0,0x6
    800029c2:	a4250513          	addi	a0,a0,-1470 # 80008400 <states.0+0x138>
    800029c6:	ffffe097          	auipc	ra,0xffffe
    800029ca:	b78080e7          	jalr	-1160(ra) # 8000053e <panic>
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    ...
    800029ec:	630080e7          	jalr	1584(ra) # 80002018 <yield>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80002a12:	a2a70713          	addi	a4,a4,-1494 # 80008438 <states.0+0x170>
  ...
  panic("argraw");
    ...
    80002a4e:	9c650513          	addi	a0,a0,-1594 # 80008410 <states.0+0x148>
...
0000000080002a5a <fetchaddr>:
{
  ...
  if(copyin(p->pagetable, (char *)ip, addr, sizeof(*ip)) != 0)
    ...
    80002a86:	7928                	ld	a0,112(a0)
    80002a88:	fffff097          	auipc	ra,0xfffff
    80002a8c:	c6c080e7          	jalr	-916(ra) # 800016f4 <copyin>
...
0000000080002aac <fetchstr>:
{
  ...
  struct proc *p = myproc();
    ...
    80002ac4:	eec080e7          	jalr	-276(ra) # 800019ac <myproc>
  if(copyinstr(p->pagetable, buf, addr, max) < 0)
    80002ac8:	86ce                	mv	a3,s3
    80002aca:	864a                	mv	a2,s2
    80002acc:	85a6                	mv	a1,s1
    80002ace:	7928                	ld	a0,112(a0)
    80002ad0:	fffff097          	auipc	ra,0xfffff
    80002ad4:	cb2080e7          	jalr	-846(ra) # 80001782 <copyinstr>
    80002ad8:	00054e63          	bltz	a0,80002af4 <fetchstr+0x48>
  return strlen(buf);
    80002adc:	8526                	mv	a0,s1
    80002ade:	ffffe097          	auipc	ra,0xffffe
    80002ae2:	370080e7          	jalr	880(ra) # 80000e4e <strlen>
}
    ...
    80002af6:	bfc5                	j	80002ae6 <fetchstr+0x3a>

0000000080002af8 <argint>:
...
argint(int n, int *ip)
{
  ...
  *ip = argraw(n);
    ...
    80002b08:	eee080e7          	jalr	-274(ra) # 800029f2 <argraw>
...
argaddr(int n, uint64 *ip)
{
  ...
  *ip = argraw(n);
    ...
    80002b28:	ece080e7          	jalr	-306(ra) # 800029f2 <argraw>
...
argstr(int n, char *buf, int max)
{
  ...
  uint64 addr;
  argaddr(n, &addr);
    80002b48:	fd840593          	addi	a1,s0,-40
    80002b4c:	00000097          	auipc	ra,0x0
    80002b50:	fcc080e7          	jalr	-52(ra) # 80002b18 <argaddr>
  return fetchstr(addr, buf, max);
    80002b54:	864a                	mv	a2,s2
    80002b56:	85a6                	mv	a1,s1
    80002b58:	fd843503          	ld	a0,-40(s0)
    80002b5c:	00000097          	auipc	ra,0x0
    80002b60:	f50080e7          	jalr	-176(ra) # 80002aac <fetchstr>
}
...
syscall(void)
{
  ...
  struct proc *p = myproc();
    ...
    80002b80:	e30080e7          	jalr	-464(ra) # 800019ac <myproc>
    80002b84:	84aa                	mv	s1,a0

  num = p->trapframe->a7;
    80002b86:	07853903          	ld	s2,120(a0)
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002ba2:	8b278793          	addi	a5,a5,-1870 # 80008450 <syscalls>
...
sys_exit(void)
{
    80002bdc:	7139                	addi	sp,sp,-64
    80002bde:	fc06                	sd	ra,56(sp)
    80002be0:	f822                	sd	s0,48(sp)
  ...
  argint(0, &n);
    ...
    80002bee:	f0e080e7          	jalr	-242(ra) # 80002af8 <argint>
  char buff[32];
  argstr(1, buff, 32);
    80002bf2:	02000613          	li	a2,32
    80002bf6:	fc840593          	addi	a1,s0,-56
    80002bfa:	4505                	li	a0,1
    80002bfc:	00000097          	auipc	ra,0x0
    80002c00:	f3c080e7          	jalr	-196(ra) # 80002b38 <argstr>
  exit(n, buff);
    80002c04:	fc840593          	addi	a1,s0,-56
    80002c08:	fec42503          	lw	a0,-20(s0)
    80002c0c:	fffff097          	auipc	ra,0xfffff
    80002c10:	57c080e7          	jalr	1404(ra) # 80002188 <exit>
  return 0;  // not reached
}
    80002c14:	4501                	li	a0,0
    80002c16:	70e2                	ld	ra,56(sp)
    80002c18:	7442                	ld	s0,48(sp)
    80002c1a:	6121                	addi	sp,sp,64
    80002c1c:	8082                	ret
...
sys_fork(void)
{
  ...
  return fork();
    ...
    80002c44:	122080e7          	jalr	290(ra) # 80001d62 <fork>
}
...
sys_wait(void)
{
    80002c50:	7139                	addi	sp,sp,-64
    80002c52:	fc06                	sd	ra,56(sp)
    80002c54:	f822                	sd	s0,48(sp)
  ...
  argaddr(0, &p);
    ...
    80002c62:	eba080e7          	jalr	-326(ra) # 80002b18 <argaddr>
  char buff[32];
  argstr(1, buff, 32);
    80002c66:	02000613          	li	a2,32
    80002c6a:	fc840593          	addi	a1,s0,-56
    80002c6e:	4505                	li	a0,1
    80002c70:	00000097          	auipc	ra,0x0
    80002c74:	ec8080e7          	jalr	-312(ra) # 80002b38 <argstr>
  return wait(p, buff);
    80002c78:	fc840593          	addi	a1,s0,-56
    80002c7c:	fe843503          	ld	a0,-24(s0)
    80002c80:	fffff097          	auipc	ra,0xfffff
    80002c84:	6c4080e7          	jalr	1732(ra) # 80002344 <wait>
} 
    80002c88:	70e2                	ld	ra,56(sp)
    80002c8a:	7442                	ld	s0,48(sp)
    80002c8c:	6121                	addi	sp,sp,64
    80002c8e:	8082                	ret
...
sys_sbrk(void)
{
  ...
  argint(0, &n);
    ...
    80002ca4:	e58080e7          	jalr	-424(ra) # 80002af8 <argint>
  addr = myproc()->sz;
    80002ca8:	fffff097          	auipc	ra,0xfffff
    80002cac:	d04080e7          	jalr	-764(ra) # 800019ac <myproc>
    80002cb0:	7524                	ld	s1,104(a0)
  if(growproc(n) < 0)
    80002cb2:	fdc42503          	lw	a0,-36(s0)
    80002cb6:	fffff097          	auipc	ra,0xfffff
    80002cba:	050080e7          	jalr	80(ra) # 80001d06 <growproc>
    80002cbe:	00054863          	bltz	a0,80002cce <sys_sbrk+0x3e>
    return -1;
  return addr;
}
    ...
    80002cd0:	bfcd                	j	80002cc2 <sys_sbrk+0x32>
...
sys_sleep(void)
{
  ...
  argint(0, &n);
    ...
    80002cea:	e12080e7          	jalr	-494(ra) # 80002af8 <argint>
  acquire(&tickslock);
    80002cee:	00014517          	auipc	a0,0x14
    80002cf2:	4a250513          	addi	a0,a0,1186 # 80017190 <tickslock>
    80002cf6:	ffffe097          	auipc	ra,0xffffe
    80002cfa:	ee0080e7          	jalr	-288(ra) # 80000bd6 <acquire>
  ticks0 = ticks;
    80002cfe:	00006917          	auipc	s2,0x6
    80002d02:	bf292903          	lw	s2,-1038(s2) # 800088f0 <ticks>
  while(ticks - ticks0 < n){
    80002d06:	fcc42783          	lw	a5,-52(s0)
    80002d0a:	cf9d                	beqz	a5,80002d48 <sys_sleep+0x76>
    if(killed(myproc())){
      release(&tickslock);
      return -1;
    }
    ...
    80002d10:	48498993          	addi	s3,s3,1156 # 80017190 <tickslock>
    ...
    80002d28:	5ee080e7          	jalr	1518(ra) # 80002312 <killed>
    80002d2c:	ed15                	bnez	a0,80002d68 <sys_sleep+0x96>
    sleep(&ticks, &tickslock);
    80002d2e:	85ce                	mv	a1,s3
    80002d30:	8526                	mv	a0,s1
    80002d32:	fffff097          	auipc	ra,0xfffff
    80002d36:	322080e7          	jalr	802(ra) # 80002054 <sleep>
  while(ticks - ticks0 < n){
    80002d3a:	409c                	lw	a5,0(s1)
    80002d3c:	412787bb          	subw	a5,a5,s2
    80002d40:	fcc42703          	lw	a4,-52(s0)
    80002d44:	fce7ece3          	bltu	a5,a4,80002d1c <sys_sleep+0x4a>
  }
  release(&tickslock);
    80002d48:	00014517          	auipc	a0,0x14
    80002d4c:	44850513          	addi	a0,a0,1096 # 80017190 <tickslock>
  ...
  return 0;
    ...
    80002d6c:	42850513          	addi	a0,a0,1064 # 80017190 <tickslock>
    80002d70:	ffffe097          	auipc	ra,0xffffe
    80002d74:	f1a080e7          	jalr	-230(ra) # 80000c8a <release>
      return -1;
    80002d78:	557d                	li	a0,-1
    80002d7a:	b7c5                	j	80002d5a <sys_sleep+0x88>

0000000080002d7c <sys_kill>:
...
sys_kill(void)
{
  ...
  argint(0, &pid);
    ...
    80002d8e:	d6e080e7          	jalr	-658(ra) # 80002af8 <argint>
  return kill(pid);
    80002d92:	fec42503          	lw	a0,-20(s0)
    80002d96:	fffff097          	auipc	ra,0xfffff
    80002d9a:	4de080e7          	jalr	1246(ra) # 80002274 <kill>
}
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002db4:	3e050513          	addi	a0,a0,992 # 80017190 <tickslock>
    80002db8:	ffffe097          	auipc	ra,0xffffe
    80002dbc:	e1e080e7          	jalr	-482(ra) # 80000bd6 <acquire>
  xticks = ticks;
    80002dc0:	00006497          	auipc	s1,0x6
    80002dc4:	b304a483          	lw	s1,-1232(s1) # 800088f0 <ticks>
  release(&tickslock);
    80002dc8:	00014517          	auipc	a0,0x14
    80002dcc:	3c850513          	addi	a0,a0,968 # 80017190 <tickslock>
    80002dd0:	ffffe097          	auipc	ra,0xffffe
    80002dd4:	eba080e7          	jalr	-326(ra) # 80000c8a <release>
  return xticks;
}
    80002dd8:	02049513          	slli	a0,s1,0x20
    80002ddc:	9101                	srli	a0,a0,0x20
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002e16:	6f658593          	addi	a1,a1,1782 # 80008508 <syscalls+0xb8>
    80002e1a:	00014517          	auipc	a0,0x14
    80002e1e:	38e50513          	addi	a0,a0,910 # 800171a8 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002e2e:	37e78793          	addi	a5,a5,894 # 8001f1a8 <bcache+0x8000>
    80002e32:	0001c717          	auipc	a4,0x1c
    80002e36:	5de70713          	addi	a4,a4,1502 # 8001f410 <bcache+0x8268>
    80002e3a:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002e3e:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002e42:	00014497          	auipc	s1,0x14
    80002e46:	37e48493          	addi	s1,s1,894 # 800171c0 <bcache+0x18>
    ...
    80002e52:	6c2a0a13          	addi	s4,s4,1730 # 80008510 <syscalls+0xc0>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002ea6:	30650513          	addi	a0,a0,774 # 800171a8 <bcache>
    80002eaa:	ffffe097          	auipc	ra,0xffffe
    80002eae:	d2c080e7          	jalr	-724(ra) # 80000bd6 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002eb2:	0001c497          	auipc	s1,0x1c
    80002eb6:	5ae4b483          	ld	s1,1454(s1) # 8001f460 <bcache+0x82b8>
    80002eba:	0001c797          	auipc	a5,0x1c
    80002ebe:	55678793          	addi	a5,a5,1366 # 8001f410 <bcache+0x8268>
    ...
    80002ee6:	2c650513          	addi	a0,a0,710 # 800171a8 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002f04:	5584b483          	ld	s1,1368(s1) # 8001f458 <bcache+0x82b0>
    80002f08:	0001c797          	auipc	a5,0x1c
    80002f0c:	50878793          	addi	a5,a5,1288 # 8001f410 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002f24:	5f850513          	addi	a0,a0,1528 # 80008518 <syscalls+0xc8>
    ...
    80002f44:	26850513          	addi	a0,a0,616 # 800171a8 <bcache>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002fb4:	58050513          	addi	a0,a0,1408 # 80008530 <syscalls+0xe0>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002fec:	1c050513          	addi	a0,a0,448 # 800171a8 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80003014:	19878793          	addi	a5,a5,408 # 8001f1a8 <bcache+0x8000>
    80003018:	2b87b703          	ld	a4,696(a5)
    8000301c:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    8000301e:	0001c717          	auipc	a4,0x1c
    80003022:	3f270713          	addi	a4,a4,1010 # 8001f410 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80003036:	17650513          	addi	a0,a0,374 # 800171a8 <bcache>
    ...
    80003052:	4ea50513          	addi	a0,a0,1258 # 80008538 <syscalls+0xe8>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000306e:	13e50513          	addi	a0,a0,318 # 800171a8 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003084:	12850513          	addi	a0,a0,296 # 800171a8 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800030aa:	10250513          	addi	a0,a0,258 # 800171a8 <bcache>
  ...
  release(&bcache.lock);
    ...
    800030c0:	0ec50513          	addi	a0,a0,236 # 800171a8 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    800030ec:	79c7a783          	lw	a5,1948(a5) # 8001f884 <sb+0x1c>
  ...
  brelse(bp);
    ...
    80003146:	3fe50513          	addi	a0,a0,1022 # 80008540 <syscalls+0xf0>
...
0000000080003152 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80003170:	7007a783          	lw	a5,1792(a5) # 8001f86c <sb+0x4>
    ...
    80003180:	6ecb0b13          	addi	s6,s6,1772 # 8001f868 <sb>
  ...
  printf("balloc: out of blocks\n");
    ...
    8000327a:	2e250513          	addi	a0,a0,738 # 80008558 <syscalls+0x108>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    80003366:	20e50513          	addi	a0,a0,526 # 80008570 <syscalls+0x120>
...
0000000080003372 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    8000338a:	50250513          	addi	a0,a0,1282 # 8001f888 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000339c:	50848493          	addi	s1,s1,1288 # 8001f8a0 <itable+0x18>
    800033a0:	0001e697          	auipc	a3,0x1e
    800033a4:	f9068693          	addi	a3,a3,-112 # 80021330 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    800033d0:	4bc50513          	addi	a0,a0,1212 # 8001f888 <itable>
  ...
  release(&itable.lock);
    ...
    80003400:	48c50513          	addi	a0,a0,1164 # 8001f888 <itable>
    ...
    80003422:	16a50513          	addi	a0,a0,362 # 80008588 <syscalls+0x138>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    8000344e:	41e98993          	addi	s3,s3,1054 # 8001f868 <sb>
  ...
  initlog(dev, &sb);
    ...
    80003482:	3ea58593          	addi	a1,a1,1002 # 8001f868 <sb>
    ...
    800034a2:	0fa50513          	addi	a0,a0,250 # 80008598 <syscalls+0x148>
...
00000000800034ae <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    800034c0:	0f458593          	addi	a1,a1,244 # 800085b0 <syscalls+0x160>
    800034c4:	0001c517          	auipc	a0,0x1c
    800034c8:	3c450513          	addi	a0,a0,964 # 8001f888 <itable>
    800034cc:	ffffd097          	auipc	ra,0xffffd
    800034d0:	67a080e7          	jalr	1658(ra) # 80000b46 <initlock>
  for(i = 0; i < NINODE; i++) {
    800034d4:	0001c497          	auipc	s1,0x1c
    800034d8:	3dc48493          	addi	s1,s1,988 # 8001f8b0 <itable+0x28>
    800034dc:	0001e997          	auipc	s3,0x1e
    800034e0:	e6498993          	addi	s3,s3,-412 # 80021340 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    800034e4:	00005917          	auipc	s2,0x5
    800034e8:	0d490913          	addi	s2,s2,212 # 800085b8 <syscalls+0x168>
...
000000008000350e <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80003528:	35072703          	lw	a4,848(a4) # 8001f874 <sb+0xc>
    ...
    8000353c:	330a0a13          	addi	s4,s4,816 # 8001f868 <sb>
  ...
  printf("ialloc: no inodes\n");
    ...
    80003586:	03e50513          	addi	a0,a0,62 # 800085c0 <syscalls+0x170>
...
00000000800035e0 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    800035f8:	28c5a583          	lw	a1,652(a1) # 8001f880 <sb+0x18>
...
000000008000366c <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    8000367c:	21050513          	addi	a0,a0,528 # 8001f888 <itable>
  ...
  release(&itable.lock);
    ...
    80003692:	1fa50513          	addi	a0,a0,506 # 8001f888 <itable>
...
00000000800036aa <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    800036de:	efe50513          	addi	a0,a0,-258 # 800085d8 <syscalls+0x188>
    ...
    800036f4:	1905a583          	lw	a1,400(a1) # 8001f880 <sb+0x18>
    ...
    80003760:	e8450513          	addi	a0,a0,-380 # 800085e0 <syscalls+0x190>
...
000000008000376c <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    800037ac:	e4850513          	addi	a0,a0,-440 # 800085f0 <syscalls+0x1a0>
...
0000000080003864 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80003876:	01650513          	addi	a0,a0,22 # 8001f888 <itable>
  ...
  release(&itable.lock);
    ...
    80003894:	ff850513          	addi	a0,a0,-8 # 8001f888 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    800038c8:	fc450513          	addi	a0,a0,-60 # 8001f888 <itable>
    ...
    800038fe:	f8e50513          	addi	a0,a0,-114 # 8001f888 <itable>
    ...
    80003960:	0ed7e963          	bltu	a5,a3,80003a52 <readi+0xf4>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    800039c2:	ad2080e7          	jalr	-1326(ra) # 80002490 <either_copyout>
    ...
    80003a58:	10d7e863          	bltu	a5,a3,80003b68 <writei+0x112>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80003aba:	a30080e7          	jalr	-1488(ra) # 800024e6 <either_copyin>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003bbc:	a4050513          	addi	a0,a0,-1472 # 800085f8 <syscalls+0x1a8>
    80003bc0:	ffffd097          	auipc	ra,0xffffd
    80003bc4:	97e080e7          	jalr	-1666(ra) # 8000053e <panic>
      panic("dirlookup read");
    80003bc8:	00005517          	auipc	a0,0x5
    80003bcc:	a4850513          	addi	a0,a0,-1464 # 80008610 <syscalls+0x1c0>
...
namex(char *path, int nameiparent, char *name)
{
  ...
  if(*path == '/')
    ...
    80003c72:	17053503          	ld	a0,368(a0)
...
0000000080003d9e <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003e44:	7e050513          	addi	a0,a0,2016 # 80008620 <syscalls+0x1d0>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003e9a:	49a90913          	addi	s2,s2,1178 # 80021330 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003ebe:	4a678793          	addi	a5,a5,1190 # 80021360 <log+0x30>
    ...
    80003ed2:	49660613          	addi	a2,a2,1174 # 80021364 <log+0x34>
...
0000000080003f04 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003f08:	4587a783          	lw	a5,1112(a5) # 8002135c <log+0x2c>
    80003f0c:	0af05d63          	blez	a5,80003fc6 <install_trans+0xc2>
{
    ...
    80003f2a:	43aa8a93          	addi	s5,s5,1082 # 80021360 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003f2e:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003f30:	0001d997          	auipc	s3,0x1d
    80003f34:	40098993          	addi	s3,s3,1024 # 80021330 <log>
...
0000000080003fc8 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003fde:	35648493          	addi	s1,s1,854 # 80021330 <log>
    80003fe2:	00004597          	auipc	a1,0x4
    80003fe6:	64e58593          	addi	a1,a1,1614 # 80008630 <syscalls+0x1e0>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000401e:	34670713          	addi	a4,a4,838 # 80021360 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80004052:	3007a723          	sw	zero,782(a5) # 8002135c <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    800040d2:	26250513          	addi	a0,a0,610 # 80021330 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80004102:	23248493          	addi	s1,s1,562 # 80021330 <log>
  ...
  if(log.outstanding == 0){
    ...
    80004126:	20e48493          	addi	s1,s1,526 # 80021330 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80004142:	1f248493          	addi	s1,s1,498 # 80021330 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800041ac:	1b8a8a93          	addi	s5,s5,440 # 80021360 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    800041b0:	0001da17          	auipc	s4,0x1d
    800041b4:	180a0a13          	addi	s4,s4,384 # 80021330 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004236:	1207a523          	sw	zero,298(a5) # 8002135c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80004256:	0de90913          	addi	s2,s2,222 # 80021330 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80004294:	0d070713          	addi	a4,a4,208 # 80021360 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    800042b0:	08478793          	addi	a5,a5,132 # 80021330 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    800042c8:	06c70713          	addi	a4,a4,108 # 80021330 <log>
    ...
    800042d8:	37450513          	addi	a0,a0,884 # 80008648 <syscalls+0x1f8>
    800042dc:	ffffc097          	auipc	ra,0xffffc
    800042e0:	262080e7          	jalr	610(ra) # 8000053e <panic>
    panic("log_write outside of trans");
    800042e4:	00004517          	auipc	a0,0x4
    800042e8:	37c50513          	addi	a0,a0,892 # 80008660 <syscalls+0x210>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004300:	03470713          	addi	a4,a4,52 # 80021330 <log>
  ...
  release(&log.lock);
    ...
    80004312:	02250513          	addi	a0,a0,34 # 80021330 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000433e:	34658593          	addi	a1,a1,838 # 80008680 <syscalls+0x230>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80004460:	23458593          	addi	a1,a1,564 # 80008690 <syscalls+0x240>
    80004464:	0001d517          	auipc	a0,0x1d
    80004468:	01450513          	addi	a0,a0,20 # 80021478 <ftable>
...
filealloc(void)
{
  ...
  release(&ftable.lock);
    ...
    800044b6:	fc650513          	addi	a0,a0,-58 # 80021478 <ftable>
  ...
  return 0;
    ...
    800044ce:	fae50513          	addi	a0,a0,-82 # 80021478 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800044f6:	f8650513          	addi	a0,a0,-122 # 80021478 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004510:	f6c50513          	addi	a0,a0,-148 # 80021478 <ftable>
  ...
  return f;
    ...
    8000452c:	17050513          	addi	a0,a0,368 # 80008698 <syscalls+0x248>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80004550:	f2c50513          	addi	a0,a0,-212 # 80021478 <ftable>
  ...
  release(&ftable.lock);
    ...
    8000458a:	ef250513          	addi	a0,a0,-270 # 80021478 <ftable>
...
filestat(struct file *f, uint64 addr)
{
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    80004650:	07093503          	ld	a0,112(s2)
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80004706:	cd670713          	addi	a4,a4,-810 # 800213d8 <devsw>
    ...
    8000471c:	f9850513          	addi	a0,a0,-104 # 800086b0 <syscalls+0x260>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    800047a6:	c3670713          	addi	a4,a4,-970 # 800213d8 <devsw>
  ...
  return ret;
    ...
    80004850:	e7450513          	addi	a0,a0,-396 # 800086c0 <syscalls+0x270>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    800048c0:	e1458593          	addi	a1,a1,-492 # 800086d0 <syscalls+0x280>
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(i < n){
    ...
    80004a42:	8d4080e7          	jalr	-1836(ra) # 80002312 <killed>
    ...
    80004a62:	0709b503          	ld	a0,112(s3)
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80004af4:	822080e7          	jalr	-2014(ra) # 80002312 <killed>
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    ...
    80004b44:	070a3503          	ld	a0,112(s4)
...
loadseg(pagetable_t pagetable, uint64 va, struct inode *ip, uint offset, uint sz)
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004cb4:	a2850513          	addi	a0,a0,-1496 # 800086d8 <syscalls+0x288>
  ...
  uint64 oldsz = p->sz;
    80004d22:	06853d03          	ld	s10,104(a0)
  sz = PGROUNDUP(sz);
  ...
  ustack[argc] = 0;
    ...
    80004de6:	f007b023          	sd	zero,-256(a5) # ffffffffffffef00 <end+0xffffffff7ffdc990>
  ...
  p->trapframe->a1 = sp;
    80004e18:	078bb783          	ld	a5,120(s7) # 1078 <_entry-0x7fffef88>
  ...
  safestrcpy(p->name, last, sizeof(p->name));
    ...
    80004e4a:	178b8513          	addi	a0,s7,376
    80004e4e:	ffffc097          	auipc	ra,0xffffc
    80004e52:	fce080e7          	jalr	-50(ra) # 80000e1c <safestrcpy>
  oldpagetable = p->pagetable;
    80004e56:	070bb503          	ld	a0,112(s7)
  p->pagetable = pagetable;
    80004e5a:	076bb823          	sd	s6,112(s7)
  p->sz = sz;
    80004e5e:	078bb423          	sd	s8,104(s7)
  p->trapframe->epc = elf.entry;  // initial program counter = main
    80004e62:	078bb783          	ld	a5,120(s7)
    80004e66:	e6843703          	ld	a4,-408(s0)
    80004e6a:	ef98                	sd	a4,24(a5)
  p->trapframe->sp = sp; // initial stack pointer
    80004e6c:	078bb783          	ld	a5,120(s7)
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  argint(n, &fd);
    ...
    80004f8a:	b72080e7          	jalr	-1166(ra) # 80002af8 <argint>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    80004fa4:	01e70793          	addi	a5,a4,30
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80004fe8:	0f050793          	addi	a5,a0,240
  ...
  return -1;
    ...
    80005006:	8082                	ret
      p->ofile[fd] = f;
    80005008:	01e50793          	addi	a5,a0,30
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    8000507a:	044ad783          	lhu	a5,68(s5) # fffffffffffff044 <end+0xffffffff7ffdcad4>
  ...
  return ip;
    ...
    80005120:	5dc58593          	addi	a1,a1,1500 # 800086f8 <syscalls+0x2a8>
    ...
    80005138:	5cc58593          	addi	a1,a1,1484 # 80008700 <syscalls+0x2b0>
...
00000000800051ec <sys_read>:
{
  ...
  argaddr(1, &p);
    ...
    800051fe:	91e080e7          	jalr	-1762(ra) # 80002b18 <argaddr>
  argint(2, &n);
    80005202:	fe440593          	addi	a1,s0,-28
    80005206:	4509                	li	a0,2
    80005208:	ffffe097          	auipc	ra,0xffffe
    8000520c:	8f0080e7          	jalr	-1808(ra) # 80002af8 <argint>
  if(argfd(0, 0, &f) < 0)
...
0000000080005244 <sys_write>:
{
  ...
  argaddr(1, &p);
    ...
    80005256:	8c6080e7          	jalr	-1850(ra) # 80002b18 <argaddr>
  argint(2, &n);
    8000525a:	fe440593          	addi	a1,s0,-28
    8000525e:	4509                	li	a0,2
    80005260:	ffffe097          	auipc	ra,0xffffe
    80005264:	898080e7          	jalr	-1896(ra) # 80002af8 <argint>
  if(argfd(0, 0, &f) < 0)
...
00000000800052ea <sys_fstat>:
{
  ...
  argaddr(1, &st);
    ...
    800052fc:	820080e7          	jalr	-2016(ra) # 80002b18 <argaddr>
  if(argfd(0, 0, &f) < 0)
...
0000000080005330 <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    8000534a:	7f2080e7          	jalr	2034(ra) # 80002b38 <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80005362:	7da080e7          	jalr	2010(ra) # 80002b38 <argstr>
    return -1;
...
000000008000547a <sys_unlink>:
{
  ...
  if(argstr(0, path, MAXPATH) < 0)
    ...
    80005496:	6a6080e7          	jalr	1702(ra) # 80002b38 <argstr>
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    800054c6:	23658593          	addi	a1,a1,566 # 800086f8 <syscalls+0x2a8>
    ...
    800054de:	22658593          	addi	a1,a1,550 # 80008700 <syscalls+0x2b0>
  ...
  return 0;
    ...
    8000559e:	16e50513          	addi	a0,a0,366 # 80008708 <syscalls+0x2b8>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    800055fa:	14250513          	addi	a0,a0,322 # 80008738 <syscalls+0x2e8>
...
sys_mkdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005802:	33a080e7          	jalr	826(ra) # 80002b38 <argstr>
...
sys_chdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    800058f0:	24c080e7          	jalr	588(ra) # 80002b38 <argstr>
  ...
  iput(p->cwd);
    80005924:	17093503          	ld	a0,368(s2)
  ...
  p->cwd = ip;
    80005938:	16993823          	sd	s1,368(s2)
  return 0;
...
sys_exec(void)
{
  ...
  memset(argv, 0, sizeof(argv));
    ...
    800059da:	084080e7          	jalr	132(ra) # 80002a5a <fetchaddr>
    ...
    80005a02:	0ae080e7          	jalr	174(ra) # 80002aac <fetchstr>
...
sys_pipe(void)
{
  ...
  argaddr(0, &fdarray);
    ...
    80005a96:	086080e7          	jalr	134(ra) # 80002b18 <argaddr>
...
0000000080005b80 <kernelvec>:
    ...
    80005bc0:	d67fc0ef          	jal	ra,80002926 <kerneltrap>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80005ce8:	74c78793          	addi	a5,a5,1868 # 80022430 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005cfc:	73878793          	addi	a5,a5,1848 # 80022430 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005d24:	72850513          	addi	a0,a0,1832 # 80022448 <disk+0x18>
    ...
    80005d3c:	a1050513          	addi	a0,a0,-1520 # 80008748 <syscalls+0x2f8>
    80005d40:	ffffa097          	auipc	ra,0xffffa
    80005d44:	7fe080e7          	jalr	2046(ra) # 8000053e <panic>
    panic("free_desc 2");
    80005d48:	00003517          	auipc	a0,0x3
    80005d4c:	a1050513          	addi	a0,a0,-1520 # 80008758 <syscalls+0x308>
...
0000000080005d58 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005d68:	a0458593          	addi	a1,a1,-1532 # 80008768 <syscalls+0x318>
    80005d6c:	0001c517          	auipc	a0,0x1c
    80005d70:	7ec50513          	addi	a0,a0,2028 # 80022558 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005dd4:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdc1ef>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005e1c:	61848493          	addi	s1,s1,1560 # 80022430 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005e40:	5fc73703          	ld	a4,1532(a4) # 80022438 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005e58:	5dc48493          	addi	s1,s1,1500 # 80022430 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005f78:	5e450513          	addi	a0,a0,1508 # 80022558 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f8c:	4a8b8b93          	addi	s7,s7,1192 # 80022430 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80005f96:	5c6c8c93          	addi	s9,s9,1478 # 80022558 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005fb8:	47c70713          	addi	a4,a4,1148 # 80022430 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005ff0:	45c50513          	addi	a0,a0,1116 # 80022448 <disk+0x18>
    ...
    80005ffc:	f8040a13          	addi	s4,s0,-128
{
  ...
  if(write)
    ...
    80006014:	42060613          	addi	a2,a2,1056 # 80022430 <disk>
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    ...
    8000607e:	3b668693          	addi	a3,a3,950 # 80022430 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800060ee:	46e90913          	addi	s2,s2,1134 # 80022558 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80006118:	31c78793          	addi	a5,a5,796 # 80022430 <disk>
    8000611c:	97ba                	add	a5,a5,a4
    8000611e:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80006122:	0001c997          	auipc	s3,0x1c
    80006126:	30e98993          	addi	s3,s3,782 # 80022430 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    8000614e:	40e50513          	addi	a0,a0,1038 # 80022558 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80006186:	2ae48493          	addi	s1,s1,686 # 80022430 <disk>
    8000618a:	0001c517          	auipc	a0,0x1c
    8000618e:	3ce50513          	addi	a0,a0,974 # 80022558 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80006206:	35650513          	addi	a0,a0,854 # 80022558 <disk+0x128>
    ...
    80006220:	61450513          	addi	a0,a0,1556 # 80008830 <syscalls+0x3e0>
