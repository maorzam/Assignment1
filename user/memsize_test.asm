...
int main() {
  ...
  18:	82c50513          	addi	a0,a0,-2004 # 840 <malloc+0xee>
  1c:	00000097          	auipc	ra,0x0
  20:	678080e7          	jalr	1656(ra) # 694 <printf>
   int *ptr;
   ptr = malloc(20480);
  24:	6515                	lui	a0,0x5
  26:	00000097          	auipc	ra,0x0
  2a:	72c080e7          	jalr	1836(ra) # 752 <malloc>
  2e:	84aa                	mv	s1,a0
   printf("Process size is %d\n" ,memsize());
  ...
  3e:	80650513          	addi	a0,a0,-2042 # 840 <malloc+0xee>
  42:	00000097          	auipc	ra,0x0
  46:	652080e7          	jalr	1618(ra) # 694 <printf>
   free(ptr);
  4a:	8526                	mv	a0,s1
  4c:	00000097          	auipc	ra,0x0
  50:	67e080e7          	jalr	1662(ra) # 6ca <free>
   printf("Process size is %d\n" ,memsize());
  54:	00000097          	auipc	ra,0x0
  58:	350080e7          	jalr	848(ra) # 3a4 <memsize>
  5c:	85aa                	mv	a1,a0
  5e:	00000517          	auipc	a0,0x0
  62:	7e250513          	addi	a0,a0,2018 # 840 <malloc+0xee>
  66:	00000097          	auipc	ra,0x0
  6a:	62e080e7          	jalr	1582(ra) # 694 <printf>
   return 0;
  6e:	4501                	li	a0,0
  70:	60e2                	ld	ra,24(sp)
  72:	6442                	ld	s0,16(sp)
