...
int main() {
   ...
   e:	39a080e7          	jalr	922(ra) # 3a4 <memsize>
  12:	85aa                	mv	a1,a0
  14:	00001517          	auipc	a0,0x1
  18:	81c50513          	addi	a0,a0,-2020 # 830 <malloc+0xee>
  1c:	00000097          	auipc	ra,0x0
  20:	668080e7          	jalr	1640(ra) # 684 <printf>
   int *ptr;
   ptr = malloc(20480);
  24:	6515                	lui	a0,0x5
  26:	00000097          	auipc	ra,0x0
  2a:	71c080e7          	jalr	1820(ra) # 742 <malloc>
  2e:	84aa                	mv	s1,a0
   printf("Process size is %d\n" ,memsize());
  30:	00000097          	auipc	ra,0x0
  34:	374080e7          	jalr	884(ra) # 3a4 <memsize>
  38:	85aa                	mv	a1,a0
  3a:	00000517          	auipc	a0,0x0
  3e:	7f650513          	addi	a0,a0,2038 # 830 <malloc+0xee>
  42:	00000097          	auipc	ra,0x0
  46:	642080e7          	jalr	1602(ra) # 684 <printf>
   free(ptr);
  4a:	8526                	mv	a0,s1
  4c:	00000097          	auipc	ra,0x0
  50:	66e080e7          	jalr	1646(ra) # 6ba <free>
   printf("Process size is %d\n" ,memsize());
  54:	00000097          	auipc	ra,0x0
  58:	350080e7          	jalr	848(ra) # 3a4 <memsize>
  5c:	85aa                	mv	a1,a0
  5e:	00000517          	auipc	a0,0x0
  62:	7d250513          	addi	a0,a0,2002 # 830 <malloc+0xee>
  66:	00000097          	auipc	ra,0x0
  6a:	61e080e7          	jalr	1566(ra) # 684 <printf>
   return 0;
  6e:	4501                	li	a0,0
  70:	60e2                	ld	ra,24(sp)
  72:	6442                	ld	s0,16(sp)
...
putc(int fd, char c)
{
 ...
 3c2:	f66080e7          	jalr	-154(ra) # 324 <write>
}
...
malloc(uint nbytes)
{
 ...
 81a:	b76080e7          	jalr	-1162(ra) # 38c <sbrk>
  if(p == (char*)-1)
