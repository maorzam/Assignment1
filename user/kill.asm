...
main(int argc, char **argv)
{
  ...
  2c:	1ce080e7          	jalr	462(ra) # 1f6 <atoi>
  ...
  46:	2b0080e7          	jalr	688(ra) # 2f2 <exit>
    fprintf(2, "usage: kill pid...\n");
  4a:	00000597          	auipc	a1,0x0
  4e:	7d658593          	addi	a1,a1,2006 # 820 <malloc+0xf0>
  52:	4509                	li	a0,2
  54:	00000097          	auipc	ra,0x0
  58:	5f0080e7          	jalr	1520(ra) # 644 <fprintf>
    exit(1,0);
  5c:	4581                	li	a1,0
  5e:	4505                	li	a0,1
  60:	00000097          	auipc	ra,0x0
  64:	292080e7          	jalr	658(ra) # 2f2 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	46250513          	addi	a0,a0,1122 # 840 <digits>
 3e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ae:	396b8b93          	addi	s7,s7,918 # 840 <digits>
 ...
 5ee:	24e90913          	addi	s2,s2,590 # 838 <malloc+0x108>
        while(*s != 0){
