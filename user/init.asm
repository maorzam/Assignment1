...
main(void)
{
  ...
  70:	8ac50513          	addi	a0,a0,-1876 # 918 <malloc+0x140>
  74:	00000097          	auipc	ra,0x0
  78:	6a6080e7          	jalr	1702(ra) # 71a <printf>
        exit(1,0);
  7c:	4581                	li	a1,0
  7e:	4505                	li	a0,1
  ...
  90:	83450513          	addi	a0,a0,-1996 # 8c0 <malloc+0xe8>
  94:	00000097          	auipc	ra,0x0
  98:	33e080e7          	jalr	830(ra) # 3d2 <mknod>
    open("console", O_RDWR);
  9c:	4589                	li	a1,2
  9e:	00001517          	auipc	a0,0x1
  a2:	82250513          	addi	a0,a0,-2014 # 8c0 <malloc+0xe8>
  a6:	00000097          	auipc	ra,0x0
  aa:	324080e7          	jalr	804(ra) # 3ca <open>
  ae:	bf95                	j	22 <main+0x22>
      printf("init: fork failed\n");
  b0:	00001517          	auipc	a0,0x1
  b4:	83050513          	addi	a0,a0,-2000 # 8e0 <malloc+0x108>
  b8:	00000097          	auipc	ra,0x0
  bc:	662080e7          	jalr	1634(ra) # 71a <printf>
      exit(1,0);
  c0:	4581                	li	a1,0
  c2:	4505                	li	a0,1
  ...
  d8:	82450513          	addi	a0,a0,-2012 # 8f8 <malloc+0x120>
  dc:	00000097          	auipc	ra,0x0
  e0:	2e6080e7          	jalr	742(ra) # 3c2 <exec>
      printf("init: exec sh failed\n");
  e4:	00001517          	auipc	a0,0x1
  e8:	81c50513          	addi	a0,a0,-2020 # 900 <malloc+0x128>
  ec:	00000097          	auipc	ra,0x0
  f0:	62e080e7          	jalr	1582(ra) # 71a <printf>
      exit(1,0);
  f4:	4581                	li	a1,0
  f6:	4505                	li	a0,1
...
0000000000000432 <set_ps_priority>:
...
000000000000043a <set_cfs_priority>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48a:	4ba50513          	addi	a0,a0,1210 # 940 <digits>
 48e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 556:	3eeb8b93          	addi	s7,s7,1006 # 940 <digits>
 ...
 696:	2a690913          	addi	s2,s2,678 # 938 <malloc+0x160>
        while(*s != 0){
...
free(void *ap)
{
 ...
 75e:	8b67b783          	ld	a5,-1866(a5) # 1010 <freep>
...
malloc(uint nbytes)
{
 ...
 8b0:	b66080e7          	jalr	-1178(ra) # 412 <sbrk>
  if(p == (char*)-1)
