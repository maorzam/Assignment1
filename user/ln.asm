...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
   a:	478d                	li	a5,3
   c:	02f50163          	beq	a0,a5,2e <main+0x2e>
    fprintf(2, "Usage: ln old new\n");
  10:	00001597          	auipc	a1,0x1
  14:	81058593          	addi	a1,a1,-2032 # 820 <malloc+0xe4>
  18:	4509                	li	a0,2
  ...
  2a:	2c8080e7          	jalr	712(ra) # 2ee <exit>
  2e:	84ae                	mv	s1,a1
  }
  ...
  38:	31a080e7          	jalr	794(ra) # 34e <link>
  3c:	00054863          	bltz	a0,4c <main+0x4c>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0,0);
  40:	4581                	li	a1,0
  42:	4501                	li	a0,0
  44:	00000097          	auipc	ra,0x0
  48:	2aa080e7          	jalr	682(ra) # 2ee <exit>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  4c:	6894                	ld	a3,16(s1)
  4e:	6490                	ld	a2,8(s1)
  50:	00000597          	auipc	a1,0x0
  54:	7e858593          	addi	a1,a1,2024 # 838 <malloc+0xfc>
  58:	4509                	li	a0,2
  5a:	00000097          	auipc	ra,0x0
  5e:	5f6080e7          	jalr	1526(ra) # 650 <fprintf>
  62:	bff9                	j	40 <main+0x40>
...
_main()
{
  ...
  7c:	276080e7          	jalr	630(ra) # 2ee <exit>
...
0000000000000396 <set_ps_priority>:
...
000000000000039e <set_cfs_priority>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ee:	46e50513          	addi	a0,a0,1134 # 858 <digits>
 3f2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ba:	3a2b8b93          	addi	s7,s7,930 # 858 <digits>
 ...
 5fa:	25a90913          	addi	s2,s2,602 # 850 <malloc+0x114>
        while(*s != 0){
